...
const BattleLobbyDecoder = require('./lib/decoders').BattleLobbyDecoder;
const battleLobbyDecoder = new BattleLobbyDecoder();
...
const BATTLE_LOBBY      = exports.BATTLE_LOBBY      = 'replay.server.battlelobby';
  ...
  if (archive.data[archiveFile]) {
    ...
    if (archive.protocol) {
      if (archiveFile == BATTLE_LOBBY) {
        ...
        data = battleLobbyDecoder.decode(archive.readFile(archiveFile), players);
